...
This document records the shift from a dual-form publication candidate policy to a split-canonical publication policy.
...
| Assembly Tooling | Used to verify the committed artifact | Remains available for on-demand local generation | It is a local convenience tool. |
